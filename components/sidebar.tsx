...
import { Home, Search, Users, MessageSquare, Settings, LogOut, Menu, X, Mail } from "lucide-react"
      ...
      >
        <div className="p-6 border-b border-sidebar-border">
          <Link href="/dashboard" className="flex items-center gap-2">
            ...
            <span className="font-semibold text-sidebar-foreground">SuperNetworkAI</span>
          </Link>
        </div>
